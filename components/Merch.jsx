...
at just ₹ XXX /-
      ...
      <img src="merch2.webp" className="scale-0.8" alt="" />
      <form className="space-y-6">
        <button
          type="submit"
          className="py-2 my-10 cursor-not-allowed px-5 text-sm font-medium text-center text-[#000000] rounded-lg bg-[#f4cf8b] sm:w-fit hover:bg-[#d8a657] hover:text-[#000000] focus:ring-4 focus:outline-none focus:ring-[#d8a657]"
        >
          Coming Soon...{" "}
        </button>
      </form>
